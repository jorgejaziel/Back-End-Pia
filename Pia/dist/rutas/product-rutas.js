...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, typeorm_1.getRepository)(Product_1.Product).create(req.body)];
            case 1:
                newProduct = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, typeorm_1.getRepository)(Product_1.Product).merge(product, req.body)];
            case 2:
                _a.sent();
                result = (0, typeorm_1.getRepository)(Product_1.Product).save(product);
                res.json(product);
                return [3 /*break*/, 4];
            case 3:
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, typeorm_1.getRepository)(Product_1.Product).delete(req.params.id);
